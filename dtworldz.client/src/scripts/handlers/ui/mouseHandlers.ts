import { WorldTile } from "../../models/tilemap/tile";
...
export class MouseHandler {
    ...
    attachEvents() {
        this.game.input.on(Phaser.Input.Events.POINTER_UP, (pointer: Phaser.Input.Pointer) => {
            ...
            var tile = this.game.worldMap.floorLayer.getIsoTileAtWorldXY(worldX, worldY) as WorldTile;
            if (tile) {
